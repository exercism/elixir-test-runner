...
The test runner currently targets exercises supporting Elixir >= 1.16 and Erlang/OTP >= 26, but is running on Elixir 1.20.4 on hexpm's `elixir:1.20.1-erlang-29.0-debian-bookworm-20260610` image.
