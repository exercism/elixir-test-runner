...
The test runner currently targets exercises supporting Elixir >= 1.15 and Erlang/OTP >= 26, but is running on Elixir 1.19.0 on hexpm's `elixir:1.19.0-erlang-28.1-debian-bookworm-20251020` image.
